...
Future<void> _fetchRideHistory() async {
  final userProvider = Provider.of<UserProvider>(context, listen: false);  // Assuming UserProvider
  ...
  final url = 'http://localhost:3000/api/rides/user/$userId';  // Updated API endpoint
